...
class Net(nn.Module):
    ...
    def __init__(self, patch_size=16, in_chans=3, num_classes=1000, base_channel=64, channel_ratio=4, num_med_block=0,
        ...
        self.conv_cls_head = nn.Conv2d(int(256 * channel_ratio), self.num_classes, 1, bias=False)
...
def Conformer_base(num_classes=16, **kwargs):
...
if __name__ == '__main__':
    model = Conformer_base(num_classes=7)
    print(model)
    model.eval()
