...
class Net(nn.Module):
    ...
    def __init__(self, patch_size=16, in_chans=3, num_classes=1000, base_channel=64, channel_ratio=4, num_med_block=0,
        ...
        self.fusion_head = nn.Conv2d(int(256 * channel_ratio) + embed_dim, 16, 1, bias=False)
    ...
    def forward(self, x, cam_only=False):
        ...
        if cam_only:
            ...
            cams = F.conv2d(x, self.conv_cls_head.weight).detach()
        ...
        fusion_map = torch.cat([x, x_patch], dim=1)
        fusion_map = self.fusion_head(fusion_map)
        ...
        return conv_logits, trans_logits, fusion_logit, fmap, segs
