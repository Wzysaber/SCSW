...
def load_cls_label_list(name_list_dir):
    label_dict = np.load(os.path.join(name_list_dir, 'cls_labels_onehot_Vaihingen.npy'), allow_pickle=True).item()
    modified_dict = {}
...
class vaihingenDataset(Dataset):
    def __init__(
        ...
        self.stage = stage
        self.img_dir = os.path.join(root_dir, 'Image', stage)
        self.label_dir = os.path.join(root_dir, 'Ann', stage)
    ...
    def __getitem__(self, idx):
        ...
        if self.stage == "train":
            ...
            label_dir = os.path.join(self.label_dir, _img_name[:-5] + '_label' + _img_name[-5:] + '.jpg')
...
class vaihingenClsDataset(vaihingenDataset):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
    ...
    def __getitem__(self, idx):
        ...
        cls_label = self.label_list[img_name[:-5] + '_label' + img_name[-5:]]
        ...
        if self.aug:
            ...
            return img_name, image, cls_label, img_box, local_image
        else:
            return img_name, image, cls_label


class vaihingenSegDataset(vaihingenDataset):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
