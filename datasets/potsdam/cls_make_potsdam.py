...
# 获取所有标签图像文件名
data_dir = "/home0/students/master/2022/wangzy/datasets/Potsdam_WSSS/potsdam_IRRG_wiB_512_256_dl/ann_dir/"
...
# 保存为npy格式
output_path = os.path.join(data_dir, 'cls_labels_onehot_potsdam_change.npy')
